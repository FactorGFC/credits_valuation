...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def create_user
    ...
    respond_to do |format|
      ##DESCOMENTAR-AL-TENER-UN-MAILER##
  ...
  def sign_up_params
    params.require(:user).permit(:email, :first_name, :last_name, :role_id, :avatar, :registry, :audit, :reviewer,
                                 :unit_id, :employee_number, :phone, :password)
  end
