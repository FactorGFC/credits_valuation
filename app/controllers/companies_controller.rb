class CompaniesController < ApplicationController
  ...
  before_action :set_company, only: %i[ show edit update destroy company_details open_pdf generate_financial_reasons save_data_crec_sost save_data_cobertura_deuda save_data_deuda_fin_lp save_extra_data dictamen_report dictamen_report_backup generate_cash_flow]
...
=end
  ...
  def dictamen_report_backup
    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Dictámen",
               template: "companies/dictamen_report_backup.html.slim",
               type: "application/pdf",
               disposition: "inline",
               encoding: 'UTF-8',
               dpi: '300'
