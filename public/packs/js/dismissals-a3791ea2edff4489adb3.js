...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/dismissals.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/dismissals.js":
/*!********************************************!*\
  !*** ./app/javascript/packs/dismissals.js ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var i18n_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! i18n-js */ "./node_modules/i18n-js/app/assets/javascripts/i18n.js");
/* harmony import */ var i18n_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(i18n_js__WEBPACK_IMPORTED_MODULE_2__);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('turbolinks:load', function () {
  var swalOpts = {
    buttons: {
      cancel: i18n_js__WEBPACK_IMPORTED_MODULE_2___default.a.t('messages.cancel'),
      confirm: {
        text: i18n_js__WEBPACK_IMPORTED_MODULE_2___default.a.t('messages.confirm'),
        closeModal: true
      }
    }
  };
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#enable_dismissal_review').click(function (event) {
    event.preventDefault();
    var element, resourceMsg;
    element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    resourceMsg = element.data('resource-message');
    sweetalert__WEBPACK_IMPORTED_MODULE_1___default()(resourceMsg, swalOpts).then(function (isConfirm) {
      if (!isConfirm) {
        return;
      }

      var $addVariablesForm = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#add_variables_form');
      $addVariablesForm.find('#enable_revision').val(1);
      $addVariablesForm.submit();
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#liberate_dismissal').click(function (event) {
    event.preventDefault();
    var element, resourceMsg;
    element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    resourceMsg = element.data('resource-message');
    sweetalert__WEBPACK_IMPORTED_MODULE_1___default()(resourceMsg, swalOpts).then(function (isConfirm) {
      ...
      var $form = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#liberate_form');
      $form.submit();
    });
  });
});
...
/******/ });
//# sourceMappingURL=dismissals-a3791ea2edff4489adb3.js.map