...
FReasonsConcept.create!([
     ...
     { name: 'CRECIMIENTO SOSTENIBLE', key: 'crecimiento_sostenible', formula: '(M x (1- D) x (1 + A)) / ((1/R) - (M x (1 - D) x (1 + A)))',
       description: 'Esta Razón Financiera permite determinar la tasa máxima de crecimiento en las ventas de la empresa el próximo año con base en sus actuales:
                      - Margen Neto  (M)
                      - Dividendos como % de Utilidad Neta  (D)
                      - Apalancamiento   (A)
                      - Rotación de Activos  (R).
                    Una empresa cuyas ventas se incrementen por encima de su "Crecimiento Sostenible", deberá tomar alguna de las siguientes decisiones :
                      - Incrementar su Margen Neto.
                      - Pagra menos Dividendos.
                      - Incrementar la Rotación de Activos.
                      - Recibir una inyección de capital.
                    De lo contrario tendrá que incrementa su apalancamiento.' },
     ...
     { name: 'RAZÓN CIRCULANTE', key: 'razon_circulante', formula: 'ACTIVO CIRCULANTE / PASIVO CIRCULANTE', description: 'Refleja la capacidad de la empresa de cubrir sus compromisos de corto plazo, haciendo uso de sus activos líquidos (facilmente convertibles en efectivo)' },
     ...
     { name: 'TOTAL PASIVO FINANCIERO', key: 'total_pasivo_financiero', formula: '', description: '' },
